...
{
    public class ConditionExtensionsTest : Test
    {
        public ConditionExtensionsTest(ITestOutputHelper output) : base(output)
        {
        }
        ...
        public void HasDifference_ShouldProvideDifferenceBetweenFirstAndSecond()
        {
            ...
            var sut5 = Condition.Query.HasDifference(sut1, sut2, out var sut4);
            var sut6 = Condition.Query.HasDifference(sut1, sut1, out _);
            var sut8 = Condition.Query.HasDifference(sut1, sut3, out var sut7);
