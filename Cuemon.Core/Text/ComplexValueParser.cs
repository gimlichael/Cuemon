...
namespace Cuemon.Text
{
    ...
    /// </summary>
    public class ComplexValueParser : ITypeParser<TypeConverterOptions>
    {
        /// <summary>
        ...
        /// </exception>
        /// <remarks>If the underlying <see cref="IFormatProvider"/> of <see cref="TypeConverterOptions.FormatProvider"/> is a <see cref="CultureInfo"/>, then this will be used in the conversion.</remarks>
        public object Parse(string input, Type targetType, Action<TypeConverterOptions> setup = null)
        {
        ...
        /// <returns><c>true</c> if <paramref name="input"/> was converted successfully; otherwise, <c>false</c>.</returns>
        /// <remarks>If the underlying <see cref="IFormatProvider"/> of <see cref="TypeConverterOptions.FormatProvider"/> is a <see cref="CultureInfo"/>, then this will be used in the conversion.</remarks>
        public bool TryParse(string input, Type targetType, out object result, Action<TypeConverterOptions> setup = null)
        {
