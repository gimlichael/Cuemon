...
{
    /// <summary>
    /// Computes the CRC-64 hash value for the input data using the implementation provided by the cyclic redundancy check class (CRC). This class cannot be inherited.
    /// </summary>
