...
namespace Cuemon.ComponentModel.TypeConverters
{
    ...
    /// </summary>
    public class TimeSpanDoubleConverter : IConverter<double, TimeSpan, TimeSpanDoubleOptions>
    {
        /// <summary>
        /// Converts the specified <paramref name="input"/> combined with <see cref="TimeSpanDoubleOptions.TimeUnit"/> to its equivalent <see cref="TimeSpan"/> structure.
        /// </summary>
        ...
        /// <paramref name="setup"/> was initialzied with an invalid <see cref="TimeSpanDoubleOptions.TimeUnit"/>.
        /// </exception>
        public TimeSpan ChangeType(double input, Action<TimeSpanDoubleOptions> setup)
        {
