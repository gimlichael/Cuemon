...
namespace Cuemon.ComponentModel.Parsers
{
    ...
    /// </summary>
    public class SimpleValueTypeParser : IParser<object, FormattingOptions<CultureInfo>>
    {
        /// <summary>
        ...
        public object Parse(string input, Action<FormattingOptions<CultureInfo>> setup = null)
        {
            ...
            if (input.Length > 31 && Guid.TryParse(input, out var guidinput)) { return guidinput; }
