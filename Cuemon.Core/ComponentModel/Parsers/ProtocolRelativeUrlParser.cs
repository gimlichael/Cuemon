...
namespace Cuemon.ComponentModel.Parsers
{
    ...
    public class ProtocolRelativeUrlParser : IParser<Uri, ProtocolRelativeUrlOptions>
    {
        ...
        /// <returns>A <see cref="Uri"/> similiar to <paramref name="input"/>.</returns>
        ...
        /// <param name="setup">The <see cref="ProtocolRelativeUrlOptions"/> which may be configured.</param>
        /// <returns><c>true</c> if the <paramref name="input"/> is a protocol relative URI; otherwise, <c>false</c>.</returns>
        public bool IsProtocolRelativeUrl(string input, Action<ProtocolRelativeUrlOptions> setup = null)
        {
