...
{
    /// <summary>
    /// Configuration options for <see cref="ObjectToStringConverter" />.
    /// </summary>
    /// <seealso cref="FormattingOptions{T}"/>
    public sealed class ObjectToStringOptions : FormattingOptions<CultureInfo>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ObjectToStringOptions"/> class.
        /// </summary>
        /// <remarks>
        ...
        ///        {
        ///            return string.Format(provider, "{0}={1}", property.Name, ConvertFactory.UseConverter&lt;TypeRepresentationConverter&gt;().Convert(property.PropertyType, o => o.FullName = true));
        ///        }
        ...
        /// <remarks>If <see cref="ObjectToStringConverter.ChangeType"/> is called from within an overriden <see cref="object.ToString"/> method, this property should have a value of <c>true</c> to avoid <see cref="StackOverflowException"/>.</remarks>
