...
summary: *content
---
The Cuemon.Extensions.AspNetCore.Http.Headers namespace contains extension methods that complements the Cuemon.AspNetCore.Http.Headers namespace.

Availability: NET Standard 2.0, NET Core 3.1, .NET 6.0

Complements: [Cuemon.AspNetCore.Http.Headers namespace](https://docs.cuemon.net/api/aspnet/Cuemon.AspNetCore.Http.Headers.html) 🔗
...
[master](https://github.com/gimlichael/Cuemon/tree/master/src/Cuemon.Extensions.AspNetCore/Http) 🛡️
...
|Type|Ext|Methods|
|--:|:-:|---|
|IApplicationBuilder|⬇️|`UseCorrelationIdentifier`, `UseRequestIdentifier`, `UseUserAgentSentinel`|
