...
More documentation available at [Cuemon for .NET documentation](https://docs.cuemon.net/api/extensions/aspnet/Cuemon.Extensions.AspNetCore.Authentication.html).
