...
## **Cuemon.Extensions.Asp.Versioning** for .NET

The `Cuemon.Extensions.Asp.Versioning` namespace contains types and extension methods that complements the Asp.Versioning namespace by adding new ways of working versioning for Open API 3.x.

More documentation available at [Cuemon for .NET documentation](https://docs.cuemon.net/api/extensions/aspversioning/Cuemon.Extensions.Asp.Versioning.html).
