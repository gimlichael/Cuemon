...
## **Cuemon.Extensions.Swashbuckle.AspNetCore** for .NET

The `Cuemon.Extensions.Swashbuckle.AspNetCore` namespace contains types and extension methods that complements the Swashbuckle.AspNetCore namespace by adding new ways of working with Open API 3.x.

More documentation available at our documentation site:

- [Cuemon.Extensions.Swashbuckle.AspNetCore](https://docs.cuemon.net/api/extensions/swagger/Cuemon.Extensions.Swashbuckle.AspNetCore.html) 🔗
