...
namespace Cuemon.AspNetCore.Mvc.Filters
{
    ...
    public abstract class ConfigurableAsyncActionFilter<TOptions> : Configurable<TOptions>, IAsyncActionFilter where TOptions : class, new()
    {
        /// <summary>
        ...
        protected ConfigurableAsyncActionFilter(Action<TOptions> setup) : base(setup.ConfigureOptions())
        {
        }
