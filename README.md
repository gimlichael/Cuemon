...
Your ideal companion for .NET 6, .NET Core 3.1, .NET Standard 2, Universal Windows Platform and .NET Framework 4.6.1 and newer.

It is, by heart, free, flexible and built to extend and boost your agile codebelt.

## State of the Union

Cuemon for .NET (formerly Cuemon .NET Standard) has been completely refactored and updated to support .NET 6 (LTS) - soon .NET 7.

Support for .NET Core 3.0 and .NET 5 has been deprecated as these are out of [support](https://endoflife.date/dotnet).
