...
namespace Cuemon.Reflection
{
    ...
    public static class MethodBaseConverter
    {
        ...
        public static MethodBase FromType(Type caller, [CallerMemberName] string memberName = "", BindingFlags flags = BindingFlags.Instance | BindingFlags.Static | BindingFlags.Public)
        {
            return FromType(caller, null, memberName, flags);
        }
