...
namespace Cuemon
{
    ...
    {
        private static readonly Lazy<IEnumerable<DecimalPrefix>> LazyPrefixes = new(() =>
        {
        ...
        public static DecimalPrefix Yocto => new("yocto", "y", -24);
        ...
        public static DecimalPrefix Zepto => new("zepto", "z", -21);
        ...
        public static DecimalPrefix Atto => new("atto", "a", -18);
        ...
        public static DecimalPrefix Nano => new("nano", "n", -9);
        ...
        public static DecimalPrefix Peta => new("peta", "P", 15);
        ...
        public static DecimalPrefix Exa => new("exa", "E", 18);
        ...
        public static DecimalPrefix Zetta => new("zetta", "Z", 21);
        ...
        public static DecimalPrefix Yotta => new("yotta", "Y", 24);
