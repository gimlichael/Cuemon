...
namespace Cuemon
{
    ...
    public abstract class Disposable : IDisposable
    {
        ...
        public static Task<TResult> SafeInvokeAsync<TResult>(Func<TResult> initializer, Func<TResult, Task<TResult>> tester, Action<Exception> catcher = null) where TResult : class, IDisposable
        {
            Validator.ThrowIfNull(initializer, nameof(initializer));
            Validator.ThrowIfNull(tester, nameof(tester));
            var f1 = FuncFactory.Create(tester, default);
            var f2 = ActionFactory.Create(catcher, default);
            return SafeInvokeAsyncCore(f1, initializer, f2);
        }
        ...
        /// <param name="catcher">The delegate that will handle any exceptions might thrown by <paramref name="tester"/>.</param>
        /// <returns>A task that represents the asynchronous operation. The task result contains the return value of the function delegate <paramref name="initializer"/> if the operations succeeded; otherwise null if the operation failed.</returns>
        public static Task<TResult> SafeInvokeAsync<T, TResult>(Func<TResult> initializer, Func<TResult, T, Task<TResult>> tester, T arg, Action<Exception, T> catcher = null) where TResult : class, IDisposable
        {
            Validator.ThrowIfNull(initializer, nameof(initializer));
            Validator.ThrowIfNull(tester, nameof(tester));
            var f1 = FuncFactory.Create(tester, default, arg);
        ...
        /// <param name="catcher">The delegate that will handle any exceptions might thrown by <paramref name="tester"/>.</param>
        /// <returns>A task that represents the asynchronous operation. The task result contains the return value of the function delegate <paramref name="initializer"/> if the operations succeeded; otherwise null if the operation failed.</returns>
        public static Task<TResult> SafeInvokeAsync<T1, T2, TResult>(Func<TResult> initializer, Func<TResult, T1, T2, Task<TResult>> tester, T1 arg1, T2 arg2, Action<Exception, T1, T2> catcher = null) where TResult : class, IDisposable
        {
            Validator.ThrowIfNull(initializer, nameof(initializer));
            Validator.ThrowIfNull(tester, nameof(tester));
            var f1 = FuncFactory.Create(tester, default, arg1, arg2);
        ...
        /// <param name="catcher">The delegate that will handle any exceptions might thrown by <paramref name="tester"/>.</param>
        /// <returns>A task that represents the asynchronous operation. The task result contains the return value of the function delegate <paramref name="initializer"/> if the operations succeeded; otherwise null if the operation failed.</returns>
        public static Task<TResult> SafeInvokeAsync<T1, T2, T3, TResult>(Func<TResult> initializer, Func<TResult, T1, T2, T3, Task<TResult>> tester, T1 arg1, T2 arg2, T3 arg3, Action<Exception, T1, T2, T3> catcher = null) where TResult : class, IDisposable
        {
            Validator.ThrowIfNull(initializer, nameof(initializer));
            Validator.ThrowIfNull(tester, nameof(tester));
            var f1 = FuncFactory.Create(tester, default, arg1, arg2, arg3);
        ...
        /// <param name="catcher">The delegate that will handle any exceptions might thrown by <paramref name="tester"/>.</param>
        /// <returns>A task that represents the asynchronous operation. The task result contains the return value of the function delegate <paramref name="initializer"/> if the operations succeeded; otherwise null if the operation failed.</returns>
        public static Task<TResult> SafeInvokeAsync<T1, T2, T3, T4, TResult>(Func<TResult> initializer, Func<TResult, T1, T2, T3, T4, Task<TResult>> tester, T1 arg1, T2 arg2, T3 arg3, T4 arg4, Action<Exception, T1, T2, T3, T4> catcher = null) where TResult : class, IDisposable
        {
            Validator.ThrowIfNull(initializer, nameof(initializer));
            Validator.ThrowIfNull(tester, nameof(tester));
            var f1 = FuncFactory.Create(tester, default, arg1, arg2, arg3, arg4);
        ...
        /// <param name="catcher">The delegate that will handle any exceptions might thrown by <paramref name="tester"/>.</param>
        /// <returns>A task that represents the asynchronous operation. The task result contains the return value of the function delegate <paramref name="initializer"/> if the operations succeeded; otherwise null if the operation failed.</returns>
        public static Task<TResult> SafeInvokeAsync<T1, T2, T3, T4, T5, TResult>(Func<TResult> initializer, Func<TResult, T1, T2, T3, T4, T5, Task<TResult>> tester, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, Action<Exception, T1, T2, T3, T4, T5> catcher = null) where TResult : class, IDisposable
        {
            Validator.ThrowIfNull(initializer, nameof(initializer));
            Validator.ThrowIfNull(tester, nameof(tester));
            var f1 = FuncFactory.Create(tester, default, arg1, arg2, arg3, arg4, arg5);
        ...
        private static async Task<TResult> SafeInvokeAsyncCore<TTester, TResult, TCatcher>(FuncFactory<TTester, Task<TResult>> testerFactory, Func<TResult> initializer, ActionFactory<TCatcher> catcherFactory)
            where TResult : class, IDisposable
            where TTester : Template<TResult>
            where TCatcher : Template<Exception>
        {
            ...
            {
                testerFactory.GenericArguments.Arg1 = initializer();
                testerFactory.GenericArguments.Arg1 = await testerFactory.ExecuteMethod().ConfigureAwait(false);
                result = testerFactory.GenericArguments.Arg1;
                testerFactory.GenericArguments.Arg1 = null;
            }
            catch (Exception e)
