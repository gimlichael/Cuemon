...
namespace Cuemon
{
    ...
    /// </summary>
    public static class TesterDoerUtility
    {
        /// <summary>
        ...
        /// <returns><c>true</c> if an instance of <typeparamref name="TResult"/> has been created; otherwise <c>false</c>.</returns>
        public static bool TryExecuteFunction<T, TResult>(Doer<T, TResult> method, T arg)
        {
            TResult result;
        ...
        /// <param name="arg2">The second parameter of the <paramref name="method"/>.</param>
        /// <returns><c>true</c> if an instance of <typeparamref name="TResult"/> has been created; otherwise <c>false</c>.</returns>
        public static bool TryExecuteFunction<T1, T2, TResult>(Doer<T1, T2, TResult> method, T1 arg1, T2 arg2)
        {
            TResult result;
        ...
        /// <param name="arg3">The third parameter of the <paramref name="method"/>.</param>
        /// <returns><c>true</c> if an instance of <typeparamref name="TResult"/> has been created; otherwise <c>false</c>.</returns>
        public static bool TryExecuteFunction<T1, T2, T3, TResult>(Doer<T1, T2, T3, TResult> method, T1 arg1, T2 arg2, T3 arg3)
        {
            TResult result;
        ...
        /// <param name="arg4">The fourth parameter of the <paramref name="method"/>.</param>
        /// <returns><c>true</c> if an instance of <typeparamref name="TResult"/> has been created; otherwise <c>false</c>.</returns>
        public static bool TryExecuteFunction<T1, T2, T3, T4, TResult>(Doer<T1, T2, T3, T4, TResult> method, T1 arg1, T2 arg2, T3 arg3, T4 arg4)
        {
            TResult result;
        ...
        /// <param name="arg5">The fifth parameter of the <paramref name="method"/>.</param>
        /// <returns><c>true</c> if an instance of <typeparamref name="TResult"/> has been created; otherwise <c>false</c>.</returns>
        public static bool TryExecuteFunction<T1, T2, T3, T4, T5, TResult>(Doer<T1, T2, T3, T4, T5, TResult> method, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5)
        {
            TResult result;
