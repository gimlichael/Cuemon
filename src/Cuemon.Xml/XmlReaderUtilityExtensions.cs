...
namespace Cuemon.Xml
{
    ...
    public static class XmlReaderUtilityExtensions
    {
        ...
        public static IEnumerable<XmlReader> Chunk(this XmlReader reader, int size)
        {
            return XmlReaderUtility.Chunk(reader, size);
        }
        ...
        /// </exception>
        public static IEnumerable<XmlReader> Chunk(this XmlReader reader, int size, XmlWriterSettings settings)
        {
            return XmlReaderUtility.Chunk(reader, size, settings);
        }
    }
}