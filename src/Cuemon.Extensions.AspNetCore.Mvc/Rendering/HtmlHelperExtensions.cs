...
namespace Cuemon.Extensions.AspNetCore.Mvc.Rendering
{
    ...
    public static class HtmlHelperExtensions
    {
        ...
        public static T UseWhen<T>(this IHtmlHelper helper, string action, string controller, Func<T> body)
        {
            T result = default;
        ...
        private static void UseWhenCore(IHtmlHelper helper, string action, string controller, Action whenMatchDelegate)
        {
