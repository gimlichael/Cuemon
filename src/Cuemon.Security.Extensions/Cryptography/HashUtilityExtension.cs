...
namespace Cuemon.Security.Cryptography
{
    ...
    public static class HashUtilityExtension
    {
        ...
        public static HashValue ComputeHash(this Stream value)
        {
        ...
        public static HashValue ComputeHash(this Stream value, HashAlgorithmType algorithmType)
        {
        ...
        /// <returns>A <see cref="HashValue"/> containing the computed hash value of the specified <see cref="Stream"/> <paramref name="value"/>.</returns>
        public static HashValue ComputeHash(this Stream value, HashAlgorithmType algorithmType, bool leaveStreamOpen)
        {
        ...
        public static HashValue ComputeHash(this byte[] value)
        {
            return HashUtility.ComputeHash(value);
        }
        ...
        public static HashValue ComputeHash(this byte[] value, HashAlgorithmType algorithmType)
        {
            return HashUtility.ComputeHash(value, algorithmType);
        }
        ...
        public static HashValue ComputeHash(this string value)
        {
            return HashUtility.ComputeHash(value);
        }
        ...
        public static HashValue ComputeHash(this string value, HashAlgorithmType algorithmType)
        {
            return HashUtility.ComputeHash(value, algorithmType);
        }
        ...
        /// <returns>A <see cref="HashValue"/> containing the computed hash value of the specified <see cref="string"/> <paramref name="value"/>.</returns>
        public static HashValue ComputeHash(this string value, HashAlgorithmType algorithmType, Encoding encoding)
        {
        ...
        public static HashValue ComputeHash(this object value)
        {
            return HashUtility.ComputeHash(value);
        }
        ...
        public static HashValue ComputeHash(this object value, HashAlgorithmType algorithmType)
        {
            return HashUtility.ComputeHash(value, algorithmType);
        }
        ...
        public static HashValue ComputeHash(this object[] values)
        {
        ...
        public static HashValue ComputeHash(this object[] values, HashAlgorithmType algorithmType)
        {
        ...
        public static HashValue ComputeHash(this string[] values)
        {
            return HashUtility.ComputeHash(values);
        }
        ...
        public static HashValue ComputeHash(this string[] values, HashAlgorithmType algorithmType)
        {
            return HashUtility.ComputeHash(values, algorithmType);
        }
        ...
        /// <returns>A <see cref="HashValue"/> containing the computed hash value of the specified <see cref="string"/> sequence, <paramref name="values"/>.</returns>
        public static HashValue ComputeHash(this string[] values, HashAlgorithmType algorithmType, Encoding encoding)
        {
