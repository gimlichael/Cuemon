...
namespace Cuemon.Data
{
	...
	public abstract class DataManager
	{
        ...
        private static int ExecuteCore(DbCommand command)
        {
            try
            {
        ...
        private static DbCommand OpenConnection(DbCommand command)
        {
        ...
        private static DbDataReader ExecuteReaderCore(DbCommand command)
        {
        ...
        private static object ExecuteScalarCore(DbCommand command)
        {
            try
            {
