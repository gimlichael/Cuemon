...
namespace Cuemon.Extensions.AspNetCore.Mvc.Formatters.Newtonsoft.Json
{
    ...
    public static class HttpExceptionDescriptorResponseHandlerExtensions
    {
        ...
        /// </exception>
        public static ICollection<HttpExceptionDescriptorResponseHandler> AddNewtonsoftJsonResponseHandler(this ICollection<HttpExceptionDescriptorResponseHandler> handlers, HttpExceptionDescriptor descriptor, Action<ExceptionDescriptorOptions> setup = null)
        {
