...
namespace Cuemon.Extensions.AspNetCore.Mvc.Formatters.Newtonsoft.Json
{
    ...
    public static class MvcCoreBuilderExtensions
    {
        ...
        /// </exception>
        public static IMvcCoreBuilder AddNewtonsoftJsonSerializationFormatters(this IMvcCoreBuilder builder)
        {
        ...
        /// </exception>
        public static IMvcCoreBuilder AddNewtonsoftJsonSerializationFormatters(this IMvcCoreBuilder builder, Action<JsonFormatterOptions> setup)
        {
            Validator.ThrowIfNull(builder, nameof(builder));
