...
namespace Cuemon.Threading
{
    public static partial class AdvancedParallelFactory
    {
        ...
        /// <param name="condition">The function delegate that represents the condition section of the for loop. Default value is <see cref="Condition"/>.</param>
        ...
        public static Task<IReadOnlyCollection<TResult>> ForResultAsync<TNumber, TResult>(TNumber from, RelationalOperator relation, TNumber to, AssignmentOperator assignment, TNumber step, Func<TNumber, TResult> worker, Func<TNumber, RelationalOperator, TNumber, bool> condition = null, Func<TNumber, AssignmentOperator, TNumber, TNumber> iterator = null, Action<AsyncTaskFactoryOptions> setup = null)
            where TNumber : struct, IComparable<TNumber>, IEquatable<TNumber>, IConvertible
        {
            Calculator.ValidAsNumericOperand<TNumber>();
            Validator.ThrowIfNull(worker, nameof(worker));
            return ForResultCoreAsync(from, relation, to, assignment, step, FuncFactory.Create(worker, from), condition, iterator, setup);
        }
        ...
        public static Task<IReadOnlyCollection<TResult>> ForResultAsync<TNumber, T, TResult>(TNumber from, RelationalOperator relation, TNumber to, AssignmentOperator assignment, TNumber step, Func<TNumber, T, TResult> worker, T arg, Func<TNumber, RelationalOperator, TNumber, bool> condition = null, Func<TNumber, AssignmentOperator, TNumber, TNumber> iterator = null, Action<AsyncTaskFactoryOptions> setup = null)
            where TNumber : struct, IComparable<TNumber>, IEquatable<TNumber>, IConvertible
        {
            Calculator.ValidAsNumericOperand<TNumber>();
            Validator.ThrowIfNull(worker, nameof(worker));
            var wf = FuncFactory.Create(worker, from, arg);
        ...
        /// <returns>A <see cref="Task" /> that represents the asynchronous operation.
        /// The task result contains an <see cref="IReadOnlyCollection{TResult}" /> where the return value of the function delegate <paramref name="worker" /> is stored in the same sequential order as the for loop.</returns>
        public static Task<IReadOnlyCollection<TResult>> ForResultAsync<TNumber, T1, T2, TResult>(TNumber from, RelationalOperator relation, TNumber to, AssignmentOperator assignment, TNumber step, Func<TNumber, T1, T2, TResult> worker, T1 arg1, T2 arg2, Func<TNumber, RelationalOperator, TNumber, bool> condition = null, Func<TNumber, AssignmentOperator, TNumber, TNumber> iterator = null, Action<AsyncTaskFactoryOptions> setup = null)
            where TNumber : struct, IComparable<TNumber>, IEquatable<TNumber>, IConvertible
        {
            Calculator.ValidAsNumericOperand<TNumber>();
            Validator.ThrowIfNull(worker, nameof(worker));
            return ForResultCoreAsync(from, relation, to, assignment, step, FuncFactory.Create(worker, from, arg1, arg2), condition, iterator, setup);
        }
        ...
        /// <returns>A <see cref="Task" /> that represents the asynchronous operation.
        /// The task result contains an <see cref="IReadOnlyCollection{TResult}" /> where the return value of the function delegate <paramref name="worker" /> is stored in the same sequential order as the for loop.</returns>
        public static Task<IReadOnlyCollection<TResult>> ForResultAsync<TNumber, T1, T2, T3, TResult>(TNumber from, RelationalOperator relation, TNumber to, AssignmentOperator assignment, TNumber step, Func<TNumber, T1, T2, T3, TResult> worker, T1 arg1, T2 arg2, T3 arg3, Func<TNumber, RelationalOperator, TNumber, bool> condition = null, Func<TNumber, AssignmentOperator, TNumber, TNumber> iterator = null, Action<AsyncTaskFactoryOptions> setup = null)
            where TNumber : struct, IComparable<TNumber>, IEquatable<TNumber>, IConvertible
        {
            Calculator.ValidAsNumericOperand<TNumber>();
            Validator.ThrowIfNull(worker, nameof(worker));
            return ForResultCoreAsync(from, relation, to, assignment, step, FuncFactory.Create(worker, from, arg1, arg2, arg3), condition, iterator, setup);
        }
        ...
        /// <returns>A <see cref="Task" /> that represents the asynchronous operation.
        /// The task result contains an <see cref="IReadOnlyCollection{TResult}" /> where the return value of the function delegate <paramref name="worker" /> is stored in the same sequential order as the for loop.</returns>
        public static Task<IReadOnlyCollection<TResult>> ForResultAsync<TNumber, T1, T2, T3, T4, TResult>(TNumber from, RelationalOperator relation, TNumber to, AssignmentOperator assignment, TNumber step, Func<TNumber, T1, T2, T3, T4, TResult> worker, T1 arg1, T2 arg2, T3 arg3, T4 arg4, Func<TNumber, RelationalOperator, TNumber, bool> condition = null, Func<TNumber, AssignmentOperator, TNumber, TNumber> iterator = null, Action<AsyncTaskFactoryOptions> setup = null)
            where TNumber : struct, IComparable<TNumber>, IEquatable<TNumber>, IConvertible
        {
            Calculator.ValidAsNumericOperand<TNumber>();
            Validator.ThrowIfNull(worker, nameof(worker));
            return ForResultCoreAsync(from, relation, to, assignment, step, FuncFactory.Create(worker, from, arg1, arg2, arg3, arg4), condition, iterator, setup);
        }
        ...
        /// <returns>A <see cref="Task" /> that represents the asynchronous operation.
        /// The task result contains an <see cref="IReadOnlyCollection{TResult}" /> where the return value of the function delegate <paramref name="worker" /> is stored in the same sequential order as the for loop.</returns>
        public static Task<IReadOnlyCollection<TResult>> ForResultAsync<TNumber, T1, T2, T3, T4, T5, TResult>(TNumber from, RelationalOperator relation, TNumber to, AssignmentOperator assignment, TNumber step, Func<TNumber, T1, T2, T3, T4, T5, TResult> worker, T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5, Func<TNumber, RelationalOperator, TNumber, bool> condition = null, Func<TNumber, AssignmentOperator, TNumber, TNumber> iterator = null, Action<AsyncTaskFactoryOptions> setup = null)
            where TNumber : struct, IComparable<TNumber>, IEquatable<TNumber>, IConvertible
        {
            Calculator.ValidAsNumericOperand<TNumber>();
            Validator.ThrowIfNull(worker, nameof(worker));
            return ForResultCoreAsync(from, relation, to, assignment, step, FuncFactory.Create(worker, from, arg1, arg2, arg3, arg4, arg5), condition, iterator, setup);
        }
